...
## Environments
- Preview: https://main--demo-pictet--aemysites.aem.page/
- Live: https://main--demo-pictet--aemysites.aem.live/
- Block Library: https://main--demo-pictet--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `demo-pictet` directory in your favorite IDE and start coding :)
